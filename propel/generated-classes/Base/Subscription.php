...
abstract class Subscription implements ActiveRecordInterface
{
    ...
    public function setSubscriptionType($v)
    {
        ...
        if ($this->subscription_type !== $v) {
            ...
            $this->modifiedColumns[SubscriptionTableMap::COL_SUBSCRIPTION_TYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SubscriptionTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SubscriptionTableMap::translateFieldName('SubscriptionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subscription_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SubscriptionTableMap::translateFieldName('SubscriptionType', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'subscription_type';
        }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setSubscriptionId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setSubscriptionType($arr[$keys[2]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SubscriptionTableMap::COL_SUBSCRIPTION_TYPE)) {
            $criteria->add(SubscriptionTableMap::COL_SUBSCRIPTION_TYPE, $this->subscription_type);
        }
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getUserId() &&
            null !== $this->getSubscriptionId() &&
            null !== $this->getSubscriptionType();

        $validPrimaryKeyFKs = 1;
        $primaryKeyFKs = [];

        //relation subscription_fk_29554a to table user
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[1] = $this->getSubscriptionId();
        $pks[2] = $this->getSubscriptionType();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setSubscriptionId($keys[1]);
        $this->setSubscriptionType($keys[2]);
    }
    ...
    {
        return (null === $this->getUserId()) && (null === $this->getSubscriptionId()) && (null === $this->getSubscriptionType());
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSubscriptionType($this->getSubscriptionType());
        if ($makeNew) {
            $copyObj->setNew(true);
        }
    }
